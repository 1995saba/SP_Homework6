...
namespace SP_Homework6
{
    ...
    {
        private List<Thread> createdThreads, waitingThreads, workingThreads;
        private Semaphore semaphore;
        private static int counterTh = 0, maxAmount = 3;
        private Dictionary<Thread, int> dictCounterTh;
        ...
        public Form()
        {
            ...
            workingListView.Columns.Add("Потоки");
            waitingListView.Columns.Add("Потоки");
            createdListView.Columns.Add("Потоки");
        ...
        private void Button_Click(object sender, EventArgs e)
        {
            ...
            createdListView.Items.Add($"Создан поток  --> {th.ManagedThreadId}");
        }
        private void Incrementer()
        {
            ...
            {
                workingListView.Invoke(new Action(() =>
                {
                    workingListView.Items.
                      Find(workingThreads.
                      IndexOf(curThread).
                      ToString(), false).
                      FirstOrDefault().
        ...
        private void WorkingListView_DoubleClick(object sender, EventArgs e)
        {
        ...
        private void WaitingListView_DoubleClick(object sender, EventArgs e)
        {
            ...
            if (counterTh < maxAmount)
            {
                ...
                th.Start();
                workingListView.Items.Add(workingThreads.IndexOf(th).ToString(), $"Работает поток -->{th.ManagedThreadId}-->0", "");
            }
        }

        private void CreatedListView_DoubleClick(object sender, EventArgs e)
        {
            ...
            waitingListView.Items.Add($"Ожидает поток --> {th.ManagedThreadId}");
        }
